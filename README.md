...
4. Once this repository is cloned, run the command `cd bash-tutorial` to move into the directory for this repo.
5. Finally, run `sudo bash welcome.sh` to run the tutorial for bash commands.
